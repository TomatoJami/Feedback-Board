...
export default function CTA() {
  return (
    <div className="w-full max-w-5xl mx-auto p-10 md:p-12 rounded-[48px] bg-white/5 border border-indigo-500/20 backdrop-blur-3xl text-center relative overflow-hidden shadow-2xl shadow-indigo-500/5 group hover:bg-white/5 hover:border-indigo-500/40 transition-all duration-500 hover:-translate-y-2">
